...
Description:
With the 2010 FIFA World Cup running, football fans the world over 
were becoming increasingly excited as the best players from the best teams 
...
namely W for win, T for tie, and L for lose. 
...
one must buy W for the 3rd game, T for the 2nd game, and T for the 1st game. 
If each bet takes 2 yuans, 
then the maximum profit would be (4.1*3.0*2.5*65%-1)*2 = 37.98 yuans 
...
and the maximum profit accurate up to 2 decimal places. 
